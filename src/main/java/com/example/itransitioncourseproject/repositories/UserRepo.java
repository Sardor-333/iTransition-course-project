...
public interface UserRepo extends JpaRepository<User, Long> {
    ...
    @Query(
            ...
            value = "select u.id                                        as id,\n" +
                    ...
                    "from users u\n" +
                    "         left join cloudinary_resources cr on cr.id = u.photo_id\n" +
                    "         join likes l on u.id = l.liked_by\n" +
                    "where l.id = :likeId"
    )
    UserProjection getUserByLikeId(@Param("likeId") Long likeId);
    ...
    UserProjection getGetUserByCommentId(@Param("commentId") Long commentId);
}
